...
//		poissons
		...
		int nbProduitAcheter = controlAcheterProduit.quantiteAchetee("Obelix",
				2);
		System.out.println("Achat de " + nbProduitAcheter + " menhirs sur 2");
		nbProduitAcheter = controlAcheterProduit.quantiteAchetee("Obelix", 3);
		System.out.println("Achat de " + nbProduitAcheter + " menhirs sur 3");
		

		nbProduitAcheter = controlAcheterProduit.quantiteAchetee("Obelix",
				2);
		System.out.println("Achat de " + nbProduitAcheter + " menhirs sur 2");
		nbProduitAcheter = controlAcheterProduit.quantiteAchetee("Obelix", 3);
		System.out.println("Achat de " + nbProduitAcheter + " menhirs sur 3");
